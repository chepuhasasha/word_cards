...
## Работа с аудио
- Скрипт `scripts/audio.js` принимает путь к `sets.json` и опциональный флаг `--rewrite-audio`, скачивает дорожки через Google Translate TTS и сохраняет их в `public/audio`.
