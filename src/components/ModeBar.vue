...
.bar
  ...
  button(:class="{ bar__active: mode === 'liked' }" @click="() => changeMode('likes')")
      svg(width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg")
...
const props = defineProps<{ mode: 'test' | 'learn' | 'write' | 'liked' }>()
const emit = defineEmits<{
  (e: 'update:mode', mode: 'test' | 'learn' | 'write' | 'liked'): void
  (e: 'open'): void
}>()
 ...
 */
const changeMode = (nextMode: 'test' | 'learn' | 'write' | 'liked'): void => {
