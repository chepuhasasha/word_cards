<template lang="pug">
.bar
  button(:class="getModeClass('learn')" @click="() => changeMode('learn')")
  ...
  button(:class="getModeClass('test')" @click="() => changeMode('test')")
    svg(width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg")
  ...
  button(:class="getModeClass('write')" @click="() => changeMode('write')")
    svg(width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg")
