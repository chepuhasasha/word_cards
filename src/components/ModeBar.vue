...
.bar
  button(
    :class="['bar__button', { 'bar__button--active': mode === 'learn' }]"
  ...
  button(
    :class="['bar__button', { 'bar__button--active': mode === 'test' }]"
  ...
  button(
    :class="['bar__button', { 'bar__button--active': mode === 'write' }]"
  ...
  button(
    v-if="hasFavorites"
    :class="['bar__button', { 'bar__button--active': useFavorites }]"
  ...
  button(@click="emit('open')" class="bar__button")
    svg(width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg")
